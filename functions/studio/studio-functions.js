...
function reverseCharecters(str) {
    let reversed = "";
    reversed = str.split('').reverse().join('');
    return reversed;
}
console.log(reverseCharecters('dhanalakshmi'));
...
function reversedCharacter(str) {
...
console.log(typeof myVariableNumber);
console.log(reversedCharacter(myVariableNumber));
...
function reverseArray(arr) {
    ...
    for (let i = arr.length - 1; i >= 0; i--) {
        arr1.push(reversedCharacter(arr[i]));
    }
    return arr1;
}
...
let phrase = "coding!"
console.log(`we put the ${funPhrase(phrase)} in ${phrase}.`);
